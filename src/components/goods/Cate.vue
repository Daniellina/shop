<template>
    <div>
        ...
        <el-card>
            ...
            border :show-row-hover="false">
                ...
                <template slot="opt" slot-scope="scope">
                    ...
                    @click="removeCatesById(scope.row.cat_id)">删除</el-button>
                </template>
            </tree-table>
            <!--分页区域-->
        ...
        width="50%" @close="addCateDialogClosed">
            ...
            ref="addCateFormRef" label-width="100px">
                ...
                <el-form-item label="父级分类：">
                    <!--options用来指定数据源-->
                    <!--props用来指定配置对象-->
                    <el-cascader :options="parentCateList" expandTrigger="hover"
        ...
        <!--编辑的对话框-->
        <el-dialog title="修改分类名称" :visible.sync="editCateDialogVisible"
        width="50%">
            <!--修改分类的表单-->
  ...
  methods: {
    ...
    editCate() {
      ...
      this.$refs.editCateFormRef.validate(async valid => {
        ...
        if (res.meta.status !== 200) {
          return this.$message.error('更新商品分类名称失败！')
        }
        // 关闭对话框
