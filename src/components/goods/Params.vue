        ...
        <el-card>
            ...
            <el-row class="cate_opt">
                <el-col>
                    <span>选择商品分类：</span>
                    <!--选择商品分类的级联选择框-->
                    <el-cascader v-model="selectedCateKeys" :options="catelist" :props="cateProps" expandTrigger="hover"
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 让文本框自动获得焦点
      // $nextTick方法的作用就是当页面上元素被重新渲染之后才会执行指定回调函数中的代码
      this.$nextTick(_ => {
